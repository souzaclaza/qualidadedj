...
const CadastroBPMN: React.FC = () => {
  const { addBPMN, setores, addSetor } = useBPMNStore();
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert('BPMN cadastrado com sucesso!');
  };
      ...
      <div className="card max-w-2xl">
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="form-group">
            <label htmlFor="titulo" className="form-label">Título do BPMN</label>
            <input
              type="text"
              id="titulo"
              value={titulo}
          ...
          <div className="form-group">
            ...
            <textarea
              ...
              className="form-input"
              rows={3}
              placeholder="Descreva o objetivo ou escopo do processo"
            />
          </div>
          ...
          <div className="flex items-start space-x-2 text-yellow-800 dark:text-yellow-200">
            ...
            <p className="text-sm">
              Após cadastrar o título do BPMN, você poderá fazer upload do arquivo correspondente.
            </p>
          </div>
